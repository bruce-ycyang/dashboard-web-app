...
class FtxClient:
    ...
    def get_orders_byID(self, id: str = None) -> List[dict]:
        return self._get(f'orders/{str(id)}')
    ...
    def get_funding_rate(self, future: str = "ETH-PERP"):
        return self._get(f'futures/' + future + f'/stats')

    def get_funding_rates(self):
        return self._get(f'funding_rates')


    def get_funding_payment(self, start_time: int = None, end_time : int = None ):
        return self._get(f'funding_payments', {'start_time' : start_time, 'end_time' :end_time})


        # "start_time": 1637139600,
        # "end_time": 1637841600,
        # "future": "ETH-PERP"
        # id 980909187

    def get_market_price_history(self,
                          market: str = None,
                          resolution: int = None,
                          start_time: int = None,
        ...
        """
            ...
            market  	string	BTC-0628	name of the market
            resolution	number	300	        window length in seconds. options: 15, 60, 300, 900,
